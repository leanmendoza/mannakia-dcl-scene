...
engine.addSystem(dyingCubeSystem)
...
export function main() {
  ...
  pointerEventsSystem.onPointerDown({ entity: startCube, opts: {
    ...
    movePlayerTo({
      newRelativePosition:Vector3.create(startPosition.x+ 5, startPosition.y + (levelAmount+2) * levelHeight, startPosition.z + 5)
  })
})
